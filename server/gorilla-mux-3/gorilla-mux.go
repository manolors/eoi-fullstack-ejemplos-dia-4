...
func insecure(w http.ResponseWriter, r *http.Request) {
}

func domainRestricted(w http.ResponseWriter, r *http.Request) {
...
func main() {
	...
	r.HandleFunc("/secure", secure).Schemes("https")
	r.HandleFunc("/insecure", insecure).Schemes("https")

	r.HandleFunc("/restricted", domainRestricted).Host("domainRestricted")
